    ...
    async function checkoutInHome(cart) {
        ...
        emailjs.send(
            ...
            "template_pjgpgn6",
            {
                ...
                total: Helper.Exchange.toMoney(total) + "VNĐ",
            ...
            {defautComplete && (
                <div className='defaulTransactionComplete'>
                    <div className='defaultwrapper'>
                        <img src='/image/success.gif' alt="Success transaction" title="Giao dịch thành công" />
                        <h2>Thanh toán đơn hàng thành công</h2>
                        <p>Chúng tôi đã gửi thông tin hóa đơn đến email của bạn</p>
                        <button onClick={rollbackToHome}>Trở về trang chính</button>
                    </div>
                </div>
            )}
        </div>
...
function CartTransaction({ display, setDisplay, setCustomer }) {
    ...
    const leftInput = [
        ...
        },
        {
            ...
            label: "Giới tính",
            data: [
                { name: "Nam", value: "1", title: "Giới tính nam" },
                { name: "Nữ", value: "0", title: "Giới tính nữ" },
            ],
        },
    ];
    ...
    const makeAddressTemplate = () =>
        `${address.detail.trim()}, ${address.commune.trim()}, ${address.district.trim()}, ${address.province.trim()}, Việt Nam`;
            ...
            <div className={`cart-info ${display ? "show" : ""}`}>
                <div className='transaction-wrapper'>
                    ...
                    <div className='behavior'>
                        <button title='Hủy thanh toán' onClick={() => setDisplay(false)}>
                            Hủy
                        </button>
                        <button title='Tiến hành thanh toán' onClick={transationHandle}>
                            Thanh toán
                        </button>
                    </div>
                </div>
                ...
                <div className='details'>
                    ...
                    <div className='amount'>
                        <div className='amountwrapper'>
                            <button title='Tăng số lượng' onClick={() => step("UP")}>
                            ...
                            <input
                                ...
                                readOnly
                            />
                            <button title='Giảm số lượng' onClick={() => step("DOWN")}>
